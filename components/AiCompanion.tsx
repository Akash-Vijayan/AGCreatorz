...
const QUICK_PROMPTS = [
  ...
  { label: "Our Process ⚙️", text: "How does AG Viztek Studio handle a project from start to finish? Explain the protocol! 🛰️" },
...
const SYSTEM_INSTRUCTION = `You are 'AG-Bot', the highly advanced Technical Sales Mascot of AG Viztek Studio. 
